...
<%
    ...
    try {
        ...
        StringBuilder query = new StringBuilder(
        		"SELECT f.flight_number, f.dept_time, f.arrival_time, f.price, a.airline_name, f.stops, " +
...
<form action="makeReservation" method="post">
    ...
    <input type="hidden" name="flight_number" value="<%= rs.getInt("flight_number") %>">
    <input type="hidden" name="depart_airportID" value="<%= depart_airportID %>">
    <input type="hidden" name="arrival_airportID" value="<%= arrival_airportID %>">
    <input type="hidden" name="depart_day" value="<%= dayId %>">
<tr>
